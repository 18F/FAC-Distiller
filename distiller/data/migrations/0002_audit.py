# Generated by Django 3.0.2 on 2020-01-20 19:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Audit',
            options={'verbose_name': 'audit detail'},
            fields=[
                ...
                ('period_covered', models.CharField(choices=[('A', 'Annual'), ('B', 'Biennial'), ('O', 'Other')], help_text='Audit Period Covered by Audit', max_length=16)),
                ...
                ('cog_over', models.CharField(blank=True, choices=[('C', 'Cognizant'), ('O', 'Oversight')], max_length=1, null=True)),
